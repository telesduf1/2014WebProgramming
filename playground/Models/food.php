...
class Food {
	...
	public static function Blank() {
		return array('id' => null, 'Name' => null, 'Calories' => null, 'Category' => null, 'Date' => null, 'Time' => null);
	}

	public static function Get($id = null) {
		$sql = "SELECT fe.id as Id, f.name as Name, f.calories as Calories, fe.category as Category, fe.date as Date, fe.time as Time FROM Food_Eaten fe, Food f WHERE fe.id=f.id";
